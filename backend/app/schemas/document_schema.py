...
class DocumentMetadata(BaseModel):
    ...
    currentStage: Optional[str] = Field("Ready", description="Active stage: Uploading, Extracting text, Extracting tables, OCR, Creating chunks, Generating embeddings, Indexing, Ready, Failed")
    stageMessage: Optional[str] = Field(None, description="Detailed stage status description")
    progressPercent: Optional[int] = Field(100, description="Real stage completion percentage")
